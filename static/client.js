...
angular.module('helpApp',['ngAnimate','ngSanitize','ui.bootstrap']);
var helpApp=angular.module('helpApp');
helpApp.controller('HelpController',function HelpController($scope,$http) {
...
helpApp.controller('AppCtrl',function ($scope,$mdDialog) {
  $scope.status = '  ';
